...
task :flash_factory do
  sh "#{DOCKER_CMD_PRIVILEGED} esptool.py -b 460800 erase_region 0x10000 0x200000"
...
task :flash_storage do
  sh "#{DOCKER_CMD_PRIVILEGED} esptool.py -b 460800 erase_region 0x210000 0x100000"
  sh "#{DOCKER_CMD_PRIVILEGED} esptool.py -b 460800 write_flash 0x210000 build/storage.bin"
end
